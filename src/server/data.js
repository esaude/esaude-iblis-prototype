    ...
    return [
        {
            ...
            testsorders: [{display: 'Urineanalysis', btn: 'primary'}, {
                display: 'Pregnacy',
                btn: 'success'
            }, {display: 'HB', btn: 'info'}, {display: 'BS', btn: 'danger'}]
        },
        {
            date: '1/05/2017', requisition: 2, nid: '1568426898518', age: 27, gender: 'F', visit: 'Ambulatorio ',
            testsorders: [{display: 'Urineanalysis', btn: 'danger'}, {
                display: 'Pregnacy',
                btn: 'success'
            }, {display: 'HB', btn: 'primary'}, {display: 'BS', btn: 'primary'}]
        },
        {
            ...
            testsorders: [{display: 'Urineanalysis', btn: 'primary'}, {
                display: 'Pregnacy',
                btn: 'danger'
            }, {display: 'HB', btn: 'success'}, {display: 'BS', btn: 'info'}]
        },
        {
            ...
            testsorders: [{display: 'Urineanalysis', btn: 'primary'}, {
                display: 'Pregnacy',
                btn: 'success'
            }, {display: 'HB', btn: 'danger'}, {display: 'BS', btn: 'primary'}]
        }
    ];
}
